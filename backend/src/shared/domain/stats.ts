...
export const BADGE_DEFS: BadgeDef[] = [
  ...
  },
  {
    id: 'REGULAR_10',
    label: 'المواظب',
    description: '10 تسجيلات وزن أو أكثر',
    icon: 'calendar',
  },
  {
    id: 'LOST_5',
    label: 'فقدان 5 كغم',
    description: 'فقدت 5 كغم منذ البداية',
    icon: 'trophy',
  },
  {
    id: 'LOST_10',
    label: 'فقدان 10 كغم',
    description: 'فقدت 10 كغم منذ البداية',
    icon: 'medal',
  },
  {
    id: 'GAINED_5',
    label: 'زيادة 5 كغم',
    description: 'اكتسبت 5 كغم من الكتلة العضلية',
    icon: 'dumbbell',
  },
  {
    id: 'STREAK_7',
    label: 'سلسلة 7 أيام',
    description: '7 أيام متتالية من الحضور',
    icon: 'flame',
  },
  {
    id: 'STREAK_30',
    label: 'سلسلة 30 يومًا',
    description: '30 يومًا متتاليًا من الحضور',
    icon: 'flame',
  },
  {
    id: 'GOAL_DONE',
  ...
  },
  {
    id: 'FIDELITY_BRONZE',
    label: 'عضو برونزي',
    description: '3 أشهر من العضوية',
    icon: 'star',
  },
  {
    id: 'FIDELITY_SILVER',
    label: 'عضو فضّي',
    description: '6 أشهر من العضوية',
    icon: 'star',
  },
  {
    id: 'FIDELITY_GOLD',
