...
import { DEFAULT_PREFS, type NotificationPrefs } from "@/shared/domain/entities";
...
export class PrefsUseCase {
  ...
  async save(userId: string, patch: Partial<NotificationPrefs>): Promise<NotificationPrefs> {
