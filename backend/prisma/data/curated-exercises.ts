...
export const CURATED_EXERCISES: CuratedExercise[] = [
  // Chest 6
  {
    ...
    category: 'Chest',
    aliases: ['incline dumbell press', 'incline dumbbell press'],
  },
  {
  ...
  },
  {
    ...
    category: 'Chest',
    aliases: ['flat dumbell press', 'flat dumbbell press'],
  },
  {
    name: 'Chest Fly Machine',
    category: 'Chest',
    aliases: ['chest fly machine'],
  },
  ...
  // Back 6
  {
    name: 'Lat Pulldown',
    category: 'Back',
    aliases: ['lat pull down', 'lat pulldown'],
  },
  { name: 'T-Bar Row', category: 'Back', aliases: ['t-bar row'] },
  {
    name: 'Dumbbell Row',
    category: 'Back',
    aliases: ['dumbell row', 'dumbbell row'],
  },
  {
  ...
  // Shoulders 6
  {
    ...
    category: 'Shoulders',
    aliases: ['shoulders dumbell press', 'shoulder dumbbell press'],
  },
  {
    name: 'Shoulder Press Machine',
    category: 'Shoulders',
    aliases: ['shoulders press machine', 'shoulder press machine'],
  },
  {
  ...
  },
  {
    ...
    category: 'Shoulders',
    aliases: ['dumbell lateral raise', 'dumbbell lateral raise'],
  },
  {
    name: 'Rear Delt Fly Machine',
    category: 'Shoulders',
    aliases: ['rare delt-fly machine', 'rear delt fly machine'],
  },
  {
    name: 'Dumbbell Shrugs',
    category: 'Shoulders',
    aliases: ['dumbell shrugs', 'dumbbell shrugs'],
  },
  ...
  { name: 'Skull Crusher', category: 'Triceps', aliases: ['skull crusher'] },
  {
    ...
    category: 'Triceps',
    aliases: ['dumbell over head', 'dumbbell overhead extension'],
  },
  {
  ...
  },
  {
    ...
    category: 'Legs',
    aliases: ['hack sequat machine', 'hack squat machine'],
  },
  {
    name: 'Smith Machine Squat',
    category: 'Legs',
    aliases: [
      'sequat smith machine',
      'squat smith machine',
      'smith machine squat',
    ],
  },
  {
    ...
    category: 'Legs',
    aliases: ['standing calf raise smith machine', 'standing calf raise'],
  },
  {
  ...
  },
  {
    ...
    category: 'Legs',
    aliases: ['bulgarian sequat', 'bulgarian split squat'],
  },
  {
    name: 'Glute Kickback',
    category: 'Legs',
    aliases: ['kick back', 'glute kickback'],
  },
  { name: 'Hip Thrust', category: 'Legs', aliases: ['hip thrust'] },
  {
    name: 'Dumbbell Squat',
    category: 'Legs',
    aliases: ['dumbell sequat', 'dumbbell squat'],
  },
  ...
  { name: 'V-Up', category: 'Abs', aliases: ['v-up', 'v up'] },
  {
    name: 'Reverse Crunch',
    category: 'Abs',
    aliases: ['revers crunche', 'reverse crunch'],
  },
