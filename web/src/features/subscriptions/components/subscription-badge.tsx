...
const CONFIG: Record<SubscriptionStatus, { label: string; className: string }> = {
  ...
  EXPIRE_BIENTOT: { label: "أوشك على الانتهاء", className: "bg-amber-500/15 text-amber-600 dark:text-amber-400 border-transparent" },
  EXPIRE: { label: "منتهي", className: "bg-destructive/12 text-destructive border-transparent" },
  ESSAI: { label: "تجريبي", className: "bg-primary/15 text-primary border-transparent" },
};
