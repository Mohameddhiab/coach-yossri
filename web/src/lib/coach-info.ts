...
export const LANDING_FAQ: LandingFaq[] = [
  {
    ...
    a: "يتراوح عدد الحصص بين ٣ و٥ أسبوعيًا بحسب مستواك وهدفك، وتتراوح مدة كل حصة بين ٦٠ و٩٠ دقيقة، موزّعة لاستهداف جميع العضلات مع أيام راحة مدروسة.",
  },
  {
...
export const COACH_INFO = {
  ...
  about:
    "منذ عام ٢٠١٨ وأنا أرافق الرياضيين من جميع المستويات — مبتدئين ومتقدّمين. أسلوبي: تدريب جادّ بمعناه الإيجابي، متابعة يومية للوزن والتغذية، وبرامج مبنية على جسمك أنت وليست على نموذج جاهز. الهدف واحد: نتيجة تظهر وتدوم.",
  stats: [
  ...
  contact: {
    ...
    hours: "الاثنين — السبت: ٩:٠٠ — ٢٢:٠٠",
